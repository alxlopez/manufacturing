...
@Component
public class SubProcessStarting extends WorkflowNodeArtifactRoutineStarting {
	@Autowired
	...
	public void execute(WorkflowNode workflowNode, ExecutionEvent event) {			
		...
		eventService.throwEvent(Long.valueOf(subProcessId), EventEntities.PROCESS, Commands.START);	
	}		
}
