...
@Component
public class SubProcessAborting extends WorkflowNodeArtifactRoutineAborting {
	@Autowired
	...
	public void execute(WorkflowNode workflowNode, ExecutionEvent event) {
		...
		eventService.throwEvent(Long.valueOf(subProcessId), EventEntities.PROCESS, Commands.ABORT);
	}
}
