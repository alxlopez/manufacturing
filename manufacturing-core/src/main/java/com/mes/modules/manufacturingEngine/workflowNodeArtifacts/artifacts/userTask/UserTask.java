package com.mes.modules.manufacturingEngine.workflowNodeArtifacts.artifacts.userTask;
...
@Component
public class UserTask implements Artifact {
	@Autowired
	protected UserActionInitiate initiateRoutine;
	@Autowired
	@Qualifier("userActionStarting")
	protected UserActionStarting startingRoutine;
	@Autowired
	@Qualifier("userActionRunning")
	protected UserActionRunning runningRoutine;
	@Autowired
