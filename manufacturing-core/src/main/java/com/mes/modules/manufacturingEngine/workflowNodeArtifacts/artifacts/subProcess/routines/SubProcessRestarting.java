...
@Component
public class SubProcessRestarting extends WorkflowNodeArtifactRoutineRestarting {
	@Autowired
	...
	public void execute(WorkflowNode workflowNode, ExecutionEvent event) {
		...
		eventService.throwEvent(Long.valueOf(subProcessId), EventEntities.PROCESS, Commands.RESTART);
	}	
}
