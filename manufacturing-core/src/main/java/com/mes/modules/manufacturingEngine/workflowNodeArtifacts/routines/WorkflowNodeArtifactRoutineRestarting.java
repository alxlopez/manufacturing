...
@Component
public abstract class WorkflowNodeArtifactRoutineRestarting extends WorkflowNodeArtifactRoutine { 		
	@Override
	public void execute(WorkflowNode workflowNode, ExecutionEvent event) {
		...
		workflowNodeService.setState(workflowNode.getArtifactId(), States.RESTARTING);		
	}
