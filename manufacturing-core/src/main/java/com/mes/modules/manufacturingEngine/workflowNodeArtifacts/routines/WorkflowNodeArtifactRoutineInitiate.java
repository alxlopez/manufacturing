...
@Component
public abstract class WorkflowNodeArtifactRoutineInitiate extends WorkflowNodeArtifactRoutine {
	@Override
	...
	public void completeRoutine(WorkflowNode workflowNode, ExecutionEvent event) {
		...
		workflowNodeService.setState(workflowNode.getArtifactId(), States.READY);
	}
}
